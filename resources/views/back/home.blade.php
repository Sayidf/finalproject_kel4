                ...
                <div class="card tryal-gradient">
                  <div class="card-body tryal row">
                    ...
                    <div class="col-xl-5 col-sm-6">
                      <img src="/public/admin/images/chart.png" alt="" class="sd-shape">
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        <div class="ms-3">
                          ...
                          <div class="final-badge">
                            <span class="badge text-black border">
                              <i class="far fa-file-alt me-3"></i>Master_file.fig </span>
                            <span class="badge text-black border">
                              <i class="fas fa-image me-2"></i>CoverPreview.jpg </span>
                  ...
                  <div class="col-xl-6 col-sm-6">
                    <div class="card">
                      <div class="card-body d-flex px-4 pb-0 justify-content-between">
                        <div>
                          <h4 class="fs-18 font-w600 mb-4 text-nowrap">Total Customer</h4>
                          <div class="d-flex align-items-center">
                  ...
                  <div class="col-xl-6 col-sm-6">
                    <div class="card">
                      <div class="card-body px-4 pb-0">
                        <h4 class="fs-18 font-w600 mb-5 text-nowrap">Total Pegawai</h4>
                      ...
                      <div class="card-body d-flex px-4  justify-content-between">
                        <div>
                          <div class="">
                            ...
                            <span class="d-block fs-16 font-w400">
                              <small class="text-success">-2%</small> than last month </span>
                          </div>
                        </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-xl-6 redial col-sm-6">
                        <div id="redial"></div>
                        <span class="text-center d-block fs-18 font-w600">On Progress <small class="text-success">70%</small>
                        </span>
                      </div>
                    </div>
                  </div>
                          ...
                          <div class="mt-3">
                            ...
                            <div class="d-flex align-items-end mt-3 pb-3 justify-content-between">
                              <span class="fs-14 font-w400">
                                <small class="font-w700 me-2">12</small>Task Done </span>
                    ...
                    <div class="msg-bx d-flex justify-content-between align-items-center">
                      <div class="msg d-flex align-items-center w-100">
                        ...
                        <div class="ms-3 w-100">
                          ...
                          <div class="d-flex justify-content-between">
                            <span class="me-auto">I don’t know where that files saved dude.</span>
                            <span class="me-4 fs-12">Yesterday, 8:24 AM</span>
                          </div>
                        </div>
                      </div>

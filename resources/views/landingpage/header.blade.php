...
<head>
  ...
  <link href="{{ asset('/public/assets/vendor/aos/aos.min.css') }}" rel="stylesheet">
  ...
  <link href="{{ asset('/public/assets/vendor/pignose-calendar/css/pignose.calendar.min.css') }}" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="{{ asset('/public/assets/css/landing.css') }}" rel="stylesheet">

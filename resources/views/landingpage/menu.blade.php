    ...
    <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
      <div class="col-lg-6 menu-item filter-rice">
        ...
        <div class="menu-content">
          <a href="#">Nasi Goreng Seafood</a><span>RP 30K</span>
        </div>
      ...
      <div class="col-lg-6 menu-item filter-rice">
        <img src="https://imgs.search.brave.com/ayCGV163wL7_8zo5dqDeFENLzkavod8-nyZy5bAqh5A/rs:fit:1200:1200:1/g:ce/aHR0cHM6Ly9pMi53/cC5jb20vY2hpbGlw/ZXBwZXJtYWRuZXNz/LmNvbS93cC1jb250/ZW50L3VwbG9hZHMv/MjAyMC8xMS9OYXNp/LUdvcmVuZy1JbmRv/bmVzaWFuLUZyaWVk/LVJpY2UtU1EuanBn" class="menu-img" alt="">
        <div class="menu-content">
          <a href="#">Nasi Goreng Spesial</a><span>RP 20K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-fish">
        ...
        <div class="menu-content">
          <a href="#">Gurami Goreng</a><span>RP 80K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-fish">
        ...
        <div class="menu-content">
          <a href="#">Kakap Goreng</a><span>RP 80K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-fish">
        ...
        <div class="menu-content">
          <a href="#">Bawal Goreng</a><span>RP 80K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-chicken">
        ...
        <div class="menu-content">
          <a href="#">Ayam Bistik</a><span>RP 40K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-chicken">
        ...
        <div class="menu-content">
          <a href="#">Ayam Goreng</a><span>RP 80K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-salads">
        ...
        <div class="menu-content">
          <a href="#">Kangkung</a><span>RP 80K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-salads">
        ...
        <div class="menu-content">
          <a href="#">Brokoli</a><span>RP 80K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-drink">
        ...
        <div class="menu-content">
          <a href="#">Teh Manis</a><span>RP 10K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-drink">
        ...
        <div class="menu-content">
          <a href="#">Teh Tarik</a><span>RP 10K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>
      <div class="col-lg-6 menu-item filter-drink">
        ...
        <div class="menu-content">
          <a href="#">Kopi</a><span>RP 10K</span>
        </div>
        <div class="menu-ingredients">
        </div>
      </div>

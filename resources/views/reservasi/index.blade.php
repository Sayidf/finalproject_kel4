                                                    ...
                                                    <div class="d-flex">
                                                        <form method="POST" id="formDelete">
                                                            ...
                                                            <a class="btn btn-primary shadow btn-xs sharp me-1"
                                                                href="{{ url('approved', $res->id) }}"><i
                                                                    class="fas fa-check"></i></a>
                                                            <button type="submit"
                                                                data-action="{{ route('reservasi.destroy', $res->id) }}"
                                                                class="btn btn-danger shadow btn-xs sharp btnDelete"
                                                                title="Hapus Reservasi"><i class="fa fa-trash"></i></button>

          ...
          <li data-filter=".filter-drink">Drink</li>
                    ...
                    <ul class="nav nav-menu mb-4" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="active show" data-bs-toggle="tab" data-bs-target="#menu-rice" aria-selected="false"
                                role="tab">
                                <div>
                        ...
                        <!-- Menu Ikan -->
                        <li class="nav-item" role="presentation">
                            <a class="" data-bs-toggle="tab" data-bs-target="#menu-fish" aria-selected="false"
                                tabindex="-1" role="tab">
                                <div>
                        ...
                        <!-- Menu Ayam -->
                        <li class="nav-item" role="presentation">
                            <a class="" data-bs-toggle="tab" data-bs-target="#menu-chicken" aria-selected="false"
                                tabindex="-1" role="tab">
                                <div>
                        ...
                        <!-- Menu Sayuran -->
                        <li class="nav-item" role="presentation">
                            <a class="" data-bs-toggle="tab" data-bs-target="#menu-salads" aria-selected="false"
                                tabindex="-1" role="tab">
                                <div>
                        ...
                        <!-- Menu Minuman -->
                        <li class="nav-item" role="presentation">
                            <a class="" data-bs-toggle="tab" data-bs-target="#menu-drink" aria-selected="false"
                                tabindex="-1" role="tab">
                                <div>
                    ...
                    <div class="row">
                        @foreach ($kategori_1 as $row)
                            <div class="col-lg-6 menu-item">
                                @empty($row->foto)
                                    <img src="{{ url('/public/assets/img/menu/placeholder.jpg') }}"alt="Menu"
                                        class="menu-img">
                                @else
                                    <img src="{{ url('/public/assets/img/menu') }}/{{ $row->foto }}"alt="Menu"
                                        class="menu-img">
                                @endempty
                                ...
                                <p class="btn-holder float-end"><a href="{{ route('add.to.cart', $row->id) }}"
                                        class="btn btn-block text-center" style="color:#cda45e" role="button">Add to
                                        cart</a> </p>
                            </div>
                        @endforeach
                    </div>
